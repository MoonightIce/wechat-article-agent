# WeChat Handoff: 如何为公众号 Agent 搭建一个可复盘的选题池

Generated from: data/drafts/topic-pool-tutorial.md

## Copy Package

### Title

如何为公众号 Agent 搭建一个可复盘的选题池
...
- Topic ID: topic-pool-tutorial
- Audience: 想把内容生产流程系统化的个人创作者和开发者
- Source: Project docs: topic pool and scoring model
- Article Type: TODO: opinion | tutorial | project-retrospective | product-note | technical | checklist
- Status: draft

## Core Claim

选题池的价值不只是存想法，而是让选题、素材、评分、写作状态和复盘形成闭环。
...
- topic-pool-doc: TODO: describe supported claims and verification status.
